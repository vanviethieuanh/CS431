...
Mọi thứ chỉ bắt đầu thay đổi một cách ngoạn mục vào năm 2012, Alex Krizhevsky và Geoffrey Hinton đã đưa ra một kiến trúc CNN phổ biến cho đến ngày nay là AlexNet, giúp giảm lỗi từ 25,8% xuống 16,4%, đây là một cải tiến đáng kể vào thời điểm đó. Và lần đầu tiên Alex net đã phá vỡ định kiến trước đó cho rằng các đặc trưng được học từ mô hình sẽ không tốt bằng các đặc trưng được tạo thủ công. Năm tiếp theo kiến trúc ZFNet là kiến trúc tiếp theo đặt được state of the art, đây là bản nâng cấp của mạng AlexNet dựa trên điều chỉnh các siêu tham số của mạng.
